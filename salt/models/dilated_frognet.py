from encoding.dilated import resnet34
...
class DilatedFrognet(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        f = torch.cat([
            ...
            torch.nn.functional.interpolate(d4, scale_factor=2, mode='bilinear', align_corners=False),
            torch.nn.functional.interpolate(d5, scale_factor=2, mode='bilinear', align_corners=False)
        ], dim=1)
